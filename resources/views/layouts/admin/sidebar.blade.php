    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          ...
          <img src="{{ url('images/administrator-icon.png') }}" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu">
        ...
        {{-- manage books --}}
        <li class="treeview @active('admin/books', 'active') @active('admin/book/show/*', 'active') @active('admin/views', 'active') @active('admin/bookmars', 'active') @active('admin/downloads', 'active') @active('admin/bookmarks', 'active') @active('admin/downloads', 'active')">
          <a href="#">
        ...
        <li class="@active('admin/users', 'active')">
